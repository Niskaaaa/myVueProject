    ...
    <div class="shopcart">
        <div class="content">
            <div class="content-left" @click="toggleShow()">
                ...
                <div class="price" :class="{highlight:totalCount}" v-if="totalPrice">￥{{totalPrice}}</div>
        ...
        <div class="shopcart-list" v-show="isShow" @click="listShow">
            <div class="list-header">
                <h1 class="title">购物车</h1> <span class="empty" @click="clearCart()">清空</span>
            </div>
            <div class="list-content">
                <ul>
                    <li class="food" v-for="(food,index) in cartFoods" :key="index"> <span class="name">{{food.name}}</span>
